...
<template>
    <InfoSection title="About">
        ...
        <p>Visit <a href="https://wp-pager.github.io" target="_blank">WP Pager official site</a> for more information, or <a href="https://wp-pager.github.io#frequently-asked-questions" target="_blank">Frequently Asked Questions</a> section to get some answers on something you might be wondering about.</p>
    </InfoSection>
</template>